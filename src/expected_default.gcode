...
G28 ; Auto-home
G1 E10.448979 F1200 X0 Y200 Z0 ; Extrude line from current location to destination (x,y,z)
G1 E10.469877 F1200 X0.4 Y200 Z0 ; Extrude line from current location to destination (x,y,z)
G1 E20.918858 F1200 X0.4 Y0 Z0 ; Extrude line from current location to destination (x,y,z)
G1 E15.918858 F1200 X0.4 Y0 Z0 ; retract filament
M140 S0 ; Set bed temp and do not wait
M104 S0 ; Set hotend temp and do not wait
M106 S0 ; Set fan speed in 0-255 range
G1 E15.918858 F1200 X0 Y200 Z10 ; Move to (x,y,z) without extruding
